"""
Calculations provided by aiida_fireengine.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'fireengine'
        ...
        spec.output('fireengine', valid_type=SinglefileData, help='diff between file1 and file2.')
